...
# Load COCO classes
classesFile = 'darknet-master/data/coco.names'
with open(classesFile, 'r') as f:
    classes = f.read().splitlines()

# Load YOLO model
net = cv2.dnn.readNetFromDarknet('darknet-master/cfg/yolov3.cfg', 'darknet-master/yolov3.weights')
...
while True:
    ...
    for output in LayerOutputs:
        for detection in output:
            ...
            if confidence > confThreshold and classes[class_id] in fruit_classes:  # Check if detected object is a fruit
